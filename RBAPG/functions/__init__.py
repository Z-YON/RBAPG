help_content="""[!]This python module is a "Wordlist Generator".
[!]This module can be used in projects based on Dictionary Attacks.
	...
	Aziz's combination algorithm. It's based on changing the certain indexes of password in the wordlist.
	    #>RBAPG.CombineCozily()
